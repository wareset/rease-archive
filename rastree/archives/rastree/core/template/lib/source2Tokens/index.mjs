...
export { TOKEN_BOOLEAN, TOKEN_COMMENT_BLOCK, TOKEN_COMMENT_LINE, TOKEN_IDENTIFIER, TOKEN_JSX_COMMENT, TOKEN_JSX_EXPRESSION_END, TOKEN_JSX_EXPRESSION_START, TOKEN_JSX_TAG_CLOSER_END, TOKEN_JSX_TAG_CLOSER_START, TOKEN_JSX_TAG_OPENER_END, TOKEN_JSX_TAG_OPENER_START, TOKEN_JSX_TEXT, TOKEN_KEYWORD, TOKEN_MODIFIER, TOKEN_NULL, TOKEN_NUMERIC, TOKEN_PUCNTUATOR, TOKEN_REGULAR_EXPRESSION, TOKEN_SPACE, TOKEN_STRING, TOKEN_TEMPLATE, source2Tokens };
